...
class Config(dict):
    ...
    def __getattr__(self, name):
        ...
        if DEFAULT_CONFIG.get(name) is not None:
            # print('WARNING: {} is not defined in {}. Using default value'.format(name, self._yaml, DEFAULT_CONFIG))
...
DEFAULT_CONFIG = {
    ...
    'MAX_ITERS': 100,               # maximum number of iterations to train the model
